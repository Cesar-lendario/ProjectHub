...
const TasksByStatusChart: React.FC = () => {
  ...
  return (
    <Card>
        <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-50 mb-3">Tarefas por Status</h3>
        {!recharts && !error && (
        ...
        {recharts && (
          <recharts.ResponsiveContainer width="100%" height={240}>
            <recharts.BarChart data={data} margin={{ top: 5, right: 20, left: -10, bottom: 0 }}>
